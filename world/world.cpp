...
{
    _spaceship = {
        { vector2d(-1, -10), 0, 255, 0 },
        { vector2d(-3, -8), 0, 255, 0 },
        { vector2d(-1, -8), 0, 0, 0 },
        { vector2d(1, -8), 0, 255, 0 },
        { vector2d(-5, -6), 0, 255, 0 },
        { vector2d(-3, -6), 0, 0, 0 },
        { vector2d(-1, -6), 0, 0, 0 },
        { vector2d(1, -6), 0, 0, 0 },
        { vector2d(3, -6), 0, 255, 0 },
        { vector2d(-5, -4), 0, 255, 0 },
        { vector2d(-3, -4), 0, 0, 0 },
        { vector2d(-1, -4), 0, 0, 0 },
        { vector2d(1, -4), 0, 0, 0 },
        { vector2d(3, -4), 0, 255, 0 },
        { vector2d(-3, -2), 0, 255, 0 },
        { vector2d(-1, -2), 0, 255, 0 },
        { vector2d(1, -2), 0, 255, 0 },
        { vector2d(-3, 0), 0, 255, 0 },
        { vector2d(-1, 0), 0, 255, 0 },
        { vector2d(1, 0), 0, 255, 0 },
        { vector2d(-3, 2), 0, 255, 0 },
        { vector2d(-1, 2), 0, 255, 0 },
        { vector2d(1, 2), 0, 255, 0 },
        { vector2d(-1, 4), 0, 255, 0 },
        { vector2d(-3, 6), 0, 255, 0 },
        { vector2d(-1, 6), 0, 255, 0 },
        { vector2d(1, 6), 0, 255, 0 },
        { vector2d(-5, 8), 0, 255, 0 },
        { vector2d(-3, 8), 0, 255, 0 },
        { vector2d(-1, 8), 0, 255, 0 },
        { vector2d(1, 8), 0, 255, 0 },
        { vector2d(3, 8), 0, 255, 0 },
...
void 
world::handle_events(SDL_Event* events) 
{ 
